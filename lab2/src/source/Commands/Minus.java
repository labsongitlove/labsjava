...
public class Minus implements ICommand {
    ...
    public String GetInfo(){
        ...
        return "Minus can't execute because in stack not enough vars.";
    }

    private void TryInitialization(ContextExecute contextExecute) throws CommandException{
        _varName1 = contextExecute.Pop();
        if (_varName1 == null){
            throw new NotEnoughArgumentsOnStackException("Minus can't execute because in stack not enough vars.");
        }
